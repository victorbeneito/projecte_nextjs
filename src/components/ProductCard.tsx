...
//   return (
//     <div className="font-poppins bg-white rounded-lg shadow-sm p-4 flex flex-col items-center border border-gray-200 hover:shadow-lg transition-all duration-300 w-full max-w-[360px] mx-auto
      ...
      >
        ...
        <div className="p-3">
          <button
            ...
            onClick={(e) => e.preventDefault()} // para que el botón no cambie la ruta aparte
          >
            Comprar
          </button>
        </div>
